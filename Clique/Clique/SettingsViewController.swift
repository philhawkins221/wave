...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SPTAuthViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        case .library:
            emptytable.selectRowAtIndexPath(NSIndexPath(forRow: 1, inSection: 0), animated: true, scrollPosition: .None)
            tableView(emptytable, didSelectRowAtIndexPath: NSIndexPath(forRow: 1, inSection: 0))
        case .magic:
            emptytable.selectRowAtIndexPath(NSIndexPath(forRow: 2, inSection: 0), animated: true, scrollPosition: .None)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cell?.textLabel?.text = "Clique Radio"
        }
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        if indexPath.row == 2 && (!currentclique.applemusic && !currentclique.spotify) {
            ...
            nope.addAction(UIAlertAction(title: "OK", style: .Cancel, handler: { action in
                ...
                self.tableView(self.emptytable, didSelectRowAtIndexPath: NSIndexPath(forRow: 0, inSection: 0))
            }))
